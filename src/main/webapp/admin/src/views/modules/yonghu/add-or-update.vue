        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="喜欢课程" prop="kechengTypes">
                        <el-select v-model="ruleForm.kechengTypes" :disabled="ro.kechengTypes" placeholder="请选择喜欢课程">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="喜欢课程" prop="kechengValue">
                        <el-input v-model="ruleForm.kechengValue"
                            placeholder="喜欢课程" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   kechengTypes: [
                              { required: true, message: '喜欢课程不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
