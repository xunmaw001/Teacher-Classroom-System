    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="喜欢课程" prop="kechengValue">
                        <el-input v-model="yonghuForm.kechengValue"
                                  placeholder="喜欢课程" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
