    ...
    */
    ...
    public R save(@RequestBody XueshengxuankeEntity xueshengxuanke, HttpServletRequest request){
        ...
        Wrapper<XueshengxuankeEntity> queryWrapper = new EntityWrapper<XueshengxuankeEntity>()
            ...
            .eq("xueshengxuanke_yesno_types", xueshengxuanke.getXueshengxuankeYesnoTypes())
            ;
...
//                            xueshengxuankeEntity.setXueshengxuankeYesnoTypes(Integer.valueOf(data.get(0)));   //审核情况 要改的
//                            xueshengxuankeEntity.setKechengContent("");//照片
//                            xueshengxuankeEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R add(@RequestBody XueshengxuankeEntity xueshengxuanke, HttpServletRequest request){
        logger.debug("add方法:,,Controller:{},,xueshengxuanke:{}",this.getClass().getName(),xueshengxuanke.toString());
        Wrapper<XueshengxuankeEntity> queryWrapper = new EntityWrapper<XueshengxuankeEntity>()
            .eq("yonghu_id", xueshengxuanke.getYonghuId())
            .eq("kecheng_id", xueshengxuanke.getKechengId())
            .eq("xueshengxuanke_yesno_types", xueshengxuanke.getXueshengxuankeYesnoTypes())
